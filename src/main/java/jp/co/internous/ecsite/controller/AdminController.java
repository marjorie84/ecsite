...
import jp.co.internous.ecsite.model.form.LogingForm;
...
public class AdminController {
	...
	@PostMapping("/welcome")
	public String welcome(LogingForm form, Model model) {
	...
	public String goodsMst(LogingForm f, Model m) {
	...
	public String addGoods(GoodsForm goodsForm, LogingForm logingForm, Model m) {
		m.addAttribute("userName", logingForm.getUserName());
		m.addAttribute("password", logingForm.getPassword());
